...
@implementation DetailViewController
{
    ...
    NIAttributedLabel *twitterLabel;
...
- (void)viewDidLoad
{
    ...
    twitterLabel = [[NIAttributedLabel alloc] init];
    twitterLabel.textAlignment = NSTextAlignmentLeft;
    twitterLabel.font = [UIFont systemFontOfSize:15.0];
    ...
    twitterLabel.lineBreakMode = UILineBreakModeWordWrap;
#else
    twitterLabel.lineBreakMode = NSLineBreakByWordWrapping;
#endif
...
- (void) loadTimeLineByUserName: (NSString *) userName {
    NSString *twAccount = [_mtItem objectForKey:@"twitter"];
    NSString *urlFormat = [NSString stringWithFormat:@"http://twitter.com/status/user_timeline/%@",twAccount];
...
- (void) loadTimeLineDidEnd: (NSNotification *)notification {
    ...
    twitterLabel.attributesForHighlightedLink = [NSDictionary dictionaryWithObject:(id)RGBCOLOR(255, 0, 0).CGColor forKey:(NSString *)kCTForegroundColorAttributeName];
    ...
    twitterLabel.autoDetectLinks = YES;
    ...
    twitterLabel.linksHaveUnderlines = NO;
    
    NSRange linkRange = [twitterLabel.text rangeOfString:twitterLabel.text];
